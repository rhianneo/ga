        ...
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="auth-input-group">
                    <input id="email" type="email" name="email" placeholder="Email" class="auth-input" value="{{ old('email', $request->email) }}" required autofocus>
                    @error('email')
                ...
                <!-- Password -->
                <div class="auth-input-group">
                    <input id="password" type="password" name="password" placeholder="New Password" class="auth-input" required>
